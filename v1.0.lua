--[[
	Encryption began at my school in a boring English lecture.	2/11/2010

	v1.0 Created On:-	3/11/2010
]]--
...
Debug.Print("NewSumOfPos = "..sumOfPos.."\r\n");
		...
		if nChar == " " then								--Space
			encText = encText.." ";
		elseif posInAlpha == 0 and posInAlphaCaps == 0 and IsNumber(nChar) == false then	--Non-Alphabets.
		...
		elseif IsNumber(nChar) and CheckBox.GetChecked("encNum") then		--Numbers	
			...
			encText = encText..nChar;		--Any other character.			
		end	
...
Debug.Print("NewDiffOfPos = "..diffOfPos.."\r\n");
		...
		if nChar == " " then
			decText = decText.." ";
		elseif posInRavi == 0 and posInRaviCaps == 0 and IsNumber(nChar) == false then			--All Other Chars
		...
		elseif IsNumber(nChar) and CheckBox.GetChecked("encNum") then		--Numbers	
			...
			decText = decText..nChar;								--Un-Encrypted Numbers
		end
